  ...
  return (
    ...
    >
      ...
      <p className="mb-4">
        ...
        <span className="font-medium"> React, Next.js, PHP, Laravel, dan Mysql</span>. 
      ...
      <p>
        <span className="italic">Saat tidak sedang coding</span>, saya menikmati bermain video game, menonton film, dan Mendengarkan Musik. Saya juga suka <span className="font-medium">mempelajari hal-hal baru</span>. Saat ini, saya sedang belajar tentang <span className="font-medium">bahasa pemrograman lain</span>.
      </p>
    </motion.section>
  );
}
